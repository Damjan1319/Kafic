    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-400">Moderan sistem za poručivanje u kafiću</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-slate-100 mb-4">Zaposleni</h2>
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-slate-100 mb-4">Gosti</h2>
        ...
        <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-3xl p-8 border border-slate-700/50 shadow-2xl">
          <h3 className="text-2xl font-bold text-slate-100 mb-6 text-center">Test Opcije</h3>
