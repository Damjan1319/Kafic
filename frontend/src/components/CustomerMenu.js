    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-gray-100 p-4 sm:p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Menu Grid */}
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8">
                    {filteredMenu.map(item => (
                        ...
                        >
                            <div className="flex items-center justify-between mb-1 sm:mb-2 md:mb-3">
                                ...
                                <span
                                    className="text-lg sm:text-base md:text-lg lg:text-xl font-bold text-emerald-400">{item.price} RSD</span>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    className="px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-3 md:py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg hover:from-blue-700 hover:to-cyan-700 transition-all duration-200 shadow text-sm sm:text-base font-medium min-w-[100px] sm:min-w-[130px] md:min-w-[150px] lg:min-w-[170px]">
                                    Dodaj
                    ...
                    <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50 animate-bounce">
                        ...
                        >
                            <div className="relative">
                                <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" fill="none" stroke="currentColor"
                                     viewBox="0 0 24 24">
                ...
                {cart.length > 0 && (
                    <div id="cart-section"
                         className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 border border-gray-700/50 shadow-2xl">
                        ...
                        <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-3 sm:mb-4 md:mb-6">
                            {cart.map(item => (
                                <div key={item.id}
                                     className="flex items-center justify-between bg-gradient-to-r from-gray-700/50 to-gray-800/50 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 border border-gray-600/50">
                        ...
                        <div className="border-t border-gray-700 pt-3 sm:pt-4 md:pt-6">
                            <div className="flex items-center justify-between mb-3 sm:mb-4 md:mb-6">
                                ...
                                <span
                                    className="text-xl sm:text-2xl md:text-3xl font-bold text-emerald-400">{Number(total).toFixed(0)} RSD</span>
                            </div>
                            <button
                                onClick={placeOrder}
